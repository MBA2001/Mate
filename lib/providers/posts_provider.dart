...
class PostsProvider extends ChangeNotifier {
  ...
  //* Adds a post
  addPost(String title,String body,String creatorName,String creatorImage) async {
    ...
    Post newPost = Post(doc.id,title,body,creatorName,creatorImage,0,0,date);
  ...
  deletePost(index) async {
    await FirebaseFirestore.instance.collection('posts').doc(_posts[index].id).delete();
